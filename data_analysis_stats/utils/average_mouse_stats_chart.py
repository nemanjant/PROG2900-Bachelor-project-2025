...
def plot_metrics_comparison(lie_data, truth_data):
    ...
    plt.tight_layout()
    plt.savefig("data_analysis_stats/graph_charts/average_mouse_stats_chart_metrics.png")
    plt.close()
...
def plot_speed_comparison(lie_data, truth_data):
    ...
    plt.tight_layout()
    plt.savefig("data_analysis_stats/graph_charts/average_mouse_speed_chart.png")
    plt.close()

# === USAGE ===
lie_file = "data_analysis_stats/averaged_data/deceitful_mouse_stats_summary.json"
truth_file = "data_analysis_stats/averaged_data/truthful_mouse_stats_summary.json"
