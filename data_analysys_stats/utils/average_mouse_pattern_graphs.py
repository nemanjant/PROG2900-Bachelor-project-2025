...
# ————————————————
# Auto-execute for both Truth and Lie
# ————————————————
...
if __name__ == "__main__":
    ...
    plot_single_path(truth_avg, label="Truthful", color="blue", output_file="graph_charts/truthful_average_mouse_path.png")
    plot_single_path(lie_avg,   label="Deceitful",   color="red", output_file="graph_charts/deceitful_average_mouse_path.png")
